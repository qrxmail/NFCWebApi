...
import { queryInspectCycles, updateInspectCycles, addInspectCycles, removeInspectCycles } from './service';
...
const handleUpdate = async fields => {
  ...
  if (isAdd){
    ...
    try {
      ...
      let result = await addInspectCycles({ ...fields });
      if (result.isSuccess){
        hide();
    ...
    try {
      let result = await updateInspectCycles({
        cycleName: fields.cycleName,
  ...
  return (
    <PageHeaderWrapper>
      <ProTable
        ...
        request={(params, sorter, filter) => queryInspectCycles({ ...params, sorter, filter })}
        columns={columns}
        rowSelection={{}}
      />
