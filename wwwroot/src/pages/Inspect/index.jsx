...
import { queryInspect, updateInspect, addInspect, removeInspect } from './service';
...
const handleUpdate = async fields => {
  ...
  if (isAdd){
    ...
    try {
      ...
      let result = await addInspect({ ...fields });
      if (result.isSuccess){
        hide();
    ...
    try {
      let result = await updateInspect({
        inspectNo: fields.inspectNo,
        inspectName: fields.inspectName,
        inspectOrderNo: fields.inspectOrderNo,
  ...
  return (
    <PageHeaderWrapper>
      <ProTable
        ...
        request={(params, sorter, filter) => queryInspect({ ...params, sorter, filter })}
        columns={columns}
        rowSelection={{}}
      />
